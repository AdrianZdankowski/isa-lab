...
public class CharacterController {
    ...
    //
    @GetMapping("api/elements/name/{elementName}/characters")
    public ResponseEntity<GetCharactersResponse> getCharactersByElementName(@PathVariable String elementName) {
        List<GetCharactersResponse.CharacterInfo> characterSummaries = characterService.getCharactersByElementName(elementName)
                .stream()
                .map(character -> GetCharactersResponse.CharacterInfo.builder()
                        .id(character.getId())
                        .name(character.getName())
